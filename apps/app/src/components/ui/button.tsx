...
export const button = cva(
  "inline-flex justify-center items-center font-medium rounded-[0.25rem] active:translate-y-0.5 transition-colors duration-200 ease-in-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-navy-600 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-60",
  {
    variants: {
      variant: {
